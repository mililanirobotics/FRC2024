...
public class SwerveControlGamepadCommand extends Command{
    ...
    public SwerveControlGamepadCommand(SwerveDriveSubsystem swerveDriveSubsystem, GenericHID gamepad) {
