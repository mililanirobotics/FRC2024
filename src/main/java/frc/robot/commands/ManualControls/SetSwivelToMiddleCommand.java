...
public class SetSwivelToMiddleCommand extends Command {
  @SuppressWarnings({"PMD.UnusedPrivateField", "PMD.SingularField"})
  private SwivelSubsystem m_swivelSubsystem;

  public SetSwivelToMiddleCommand(SwivelSubsystem swivelSubsystem) {
  ...
  public void initialize() {
    ...
    m_swivelSubsystem.setAngle(120);
  }
  ...
  public boolean isFinished() {
    return m_swivelSubsystem.getAngle() == 140;
  }
}